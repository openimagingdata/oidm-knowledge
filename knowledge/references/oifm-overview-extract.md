...
sources:
  - id: note
    ...
    title: "Finding Models: Overview, notes directory of the next-gen-2026 branch, ACR-RSNA-CDEs"
  - id: upstream
    ...
    title: prompts/overview.md, findingmodels repository, the upstream original
