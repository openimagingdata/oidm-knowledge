...
![Open Imaging Data Model: three layers joined by identifiers. Applications on top, data structures in the middle, semantic foundation below, with arrows showing which codes join them.](./architecture.svg)

*Diagram source: `architecture.excalidraw` beside this document, generated by `tools/diagrams/build_architecture.py`.*
