...
def render(
    ...
    with sync_playwright() as p:
        ...
        if svg_out is not None:
            ...
            Path(svg_out).write_text(svg_markup, encoding="utf-8")
        browser.close()
...
def main() -> None:
    ...
    parser.add_argument("--svg", type=Path, default=None, help="Also write the rendered SVG markup to this path")
    ...
    png_path = render(args.input, args.output, args.scale, args.width, svg_out=args.svg)
    print(str(png_path))
